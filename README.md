# Zherani Landing Page ΓÜí∩╕Å

Migrated from a static HTML/Tailwind site to **Qwik** for ultimate performance and production readiness.

- [Live Demo](https://zherani.my.id)
...
- **Animations**: AOS (Animate On Scroll) integrated.
- **Interactive**: Swiper for testimonials.
- **SEO Ready**: Meta tags, JSON-LD, and robots.txt configured.
